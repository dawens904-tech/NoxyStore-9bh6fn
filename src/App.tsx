  ...
  return (
    <BrowserRouter>
      ...
      <ErrorBoundary>
        ...
        <Route path="/secure-dashboard-92x2011/support" element={<AdminRoute><AdminSupportPage /></AdminRoute>} />
        <Route path="/secure-dashboard-92x2011/users" element={<AdminRoute><AdminUsersPage /></AdminRoute>} />
